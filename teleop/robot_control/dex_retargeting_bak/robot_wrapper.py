...
# from pinocchio.utils import getJointId, getJointName
...
class RobotWrapper:
    ...
    def __init__(self, urdf_path: str, use_collision=False, use_visual=False):
        ...
        print(f"Model.nqs[0]: {self.model.nqs[0]}")
        print(f"Model.nv: {self.model.nv}")
        print(f"Model.nframes: {self.model.nframes}")
        print(f"Model.frames: {self.model.frames}")
        print(f"Model.joints: {self.model.joints}")
        print(f"self.model.names: {self.model.names}")
        print(f"Model.names: {list(self.model.names)}")
        # TODO: Add visual and collision model
