...
def get_args_parser():
    ...
    parser.add_argument('--taskid', action='store', type=str, help='task id', required=False)
    parser.add_argument('--exptid', action='store', type=str, help='experiment id', required=False)
...
def build_ACT_model_and_optimizer(args_override):
    ...
    # Instead of parsing command line arguments, create default args and override
